...
.tools-root .search-icon { font-size: 1.2rem; opacity: 0.85; transition: transform 0.3s ease; }
.tools-root .search-wrapper:focus-within .search-icon { transform: scale(1.1) rotate(5deg); }
